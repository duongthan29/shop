<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i>97 Nguyễn Chí Thanh, Đống Đa, Hà Nội</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-shop.png" width="200px" alt=""></a>
				</div>
						...
						<div class="cart">
							...
							@foreach($product_cart as $product)
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="/plugin/images/{{$product['item']['image']}}" alt=""></a>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="" onclick="return false;">Loại sản phẩm</a>
							<ul class="sub-menu">

							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp->id)}}"><img src="/plugin/images/{{$sp->image}}" alt="" height="250px"></a>
									</div>
						...
						@foreach($sp_khac as $sp_k)
							<div class="col-sm-4">
								<div class="single-item">
									...
									@endif
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp_k->id)}}"><img src="/plugin/images/{{$sp_k->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">

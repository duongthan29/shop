		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
							<img src="/plugin/images/{{$sanpham->image}}" alt="">
						</div>
						<div class="col-sm-8">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sptt->id)}}"><img src="/plugin/images/{{$sptt->image}}" alt="" height="150px"></a>
									</div>
									<div class="single-item-body">
